...
public class ResponseMessageConstants {
  ...
  public static final String CASH_REGISTER_CREATE_SUCCESS = "CASH_REGISTER_CREATE_SUCCESS";
  public static final String CASH_REGISTER_UPDATE_SUCCESS = "CASH_REGISTER_UPDATE_SUCCESS";
  public static final String CASH_REGISTER_REMOVE_SUCCESS = "CASH_REGISTER_REMOVE_SUCCESS";
  public static final String CASH_REGISTER_GET_LIST_SUCCESS = "CASH_REGISTER_GET_LIST_SUCCESS";
  public static final String CASH_REGISTER_NOT_FOUND = "CASH_REGISTER_NOT_FOUND";
  public static final String CASH_REGISTER_ALREADY_EXISTS = "CASH_REGISTER_ALREADY_EXISTS";

  // ── CASH REGISTER SESSION (session de caisse) ─────────────────────
  public static final String CASH_REGISTER_SESSION_OPEN_SUCCESS = "CASH_REGISTER_SESSION_OPEN_SUCCESS";
  public static final String CASH_REGISTER_SESSION_CLOSE_SUCCESS = "CASH_REGISTER_SESSION_CLOSE_SUCCESS";
  public static final String CASH_REGISTER_SESSION_GET_LIST_SUCCESS = "CASH_REGISTER_SESSION_GET_LIST_SUCCESS";
